...
// 簡易ユーザーストア
let users = [];  // 各ユーザー { username, password, approvedFriends: [], friendRequests: [] }

// グループ管理（グループ作成・一覧取得用）
let groups = []; // 各グループ { groupId, groupName, members: [username,...] }
let nextGroupId = 1;
...
// チャット履歴取得
// 個別チャット: クエリに user1 と user2 を指定
// グループチャット: クエリに groupId を指定
